...
const causal:Record<string,CausalAudit>={
 ...
 identity:{promoterMotive:'县衙在连续死讯、刺杀与火灾后要重建城门秩序并复核身份；不同差役也会据旧记录自保。',trigger:'第8日封城榜生效，旧口供、登记与当前身份进入复核。',playerKnown:'只知道公开复核规则、自己的三栏记录和当面担保条件。',prelude:'城门增挂横木、抄录旧页并预贴逐栏复核榜。',naturalSource:'县衙封城榜公开说明复核方式。',activeSource:'比对榜文、旧口供页码与新复核簿。',recoverySource:'公示栏留存规则和个人旧登记页号，可供日后补办。',aftermath:'往后盘问按真实路引、担保、口供差异或水道记录变化。',changeable:'可改路引、追查、通行与后续公门/商道/夜行路径。',saveImpact:'resolved.identity、hasRoadPass、identity-checked/waterway、wanted 与 NPC 记忆。',tests:'A01/A02、P2-04 第八日回声、v5/v6 防补发。'},
 ...
 lastprice:{promoterMotive:'各利益方在落卷前用银钱、职位、保护或威胁购买玩家手中材料与立场。',trigger:'第57日材料、债务、追查和关系进入最后报价。',playerKnown:'只知道当面报价者、自身持有物和明确交换条件。',prelude:'不同信使问同一份材料但给出不同交割地点。',naturalSource:'具名或可辨来处的报价信送到当前落脚处。',activeSource:'核对信使、交割物、付款能力与自己实际持有材料。',recoverySource:'错过后只保留未接受报价的信封和既有债务，不补交易收益。',aftermath:'拒绝、公开或交易分别改变钱、追查、关系与终局入口。',changeable:'可接受有限交易、公开筹码或拒绝站队，承担对应代价。',saveImpact:'resolved.lastprice、money/debt/wanted、evidence、关系与末期 flags。',tests:'A01/A02、存档实物一致性与终局资格。'},
 witnessnight:{promoterMotive:'威胁者要在最终听审前驱散或压服证人；幕后主使仍须靠可核证据确认。',trigger:'第58日证人集中落脚且威胁信到达。',playerKnown:'只知道威胁信、落脚名单和当夜可用守护资源。',prelude:'巷口暗号被试探、车轮钉遭拔、威胁信写明散去时限。',naturalSource:'证人把收到的威胁信交给玩家或宁不平。',activeSource:'查守夜路线、车辆、灯号和实际到场证人。',recoverySource:'错过后从空房、遗落行李与撤回证词记录补知证人散去。',aftermath:'证人是否留下、安全屋是否有效和公开威胁材料分别进入核卷。',changeable:'可守护、用车分送、公开威胁或联络旧网，改变证人与终局助力。',saveImpact:'resolved.witnessnight、witness-safe、safehouse/关系/钱与终局助阵。',tests:'A01/A02、终局证人状态和缺席不补救人。'},
};
